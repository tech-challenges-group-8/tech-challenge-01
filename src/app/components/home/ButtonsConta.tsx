...
import { Alert, Box, Button, Checkbox, Dialog, DialogActions, DialogContent, DialogTitle, FormControlLabel, IconButton, Snackbar, styled, TextField, Typography } from "@mui/material";
    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <Box sx={{ display: { xs: 'none', sm: 'none', lg: 'block' } }}>
                <CustomButton
                    variant="contained"
                    onClick={() => {setIsRegisterOpen(true); zerarCampos();}}
                >
                    Abrir minha conta
                </CustomButton>
            </Box>
            ...
            <CustomButton
                variant="contained"
                sx={{ width: '180px', height: '48px', borderRadius: '8px', backgroundColor: '#47A138', color: '#FFFFFF', fontWeight: '600', fontSize: '16px', border: '2px solid #47A138', textTransform: 'none', '&:hover': { backgroundColor: 'transparent', color: '#47A138', padding: '0px' } }}
                onClick={() => {setIsLoginOpen(true); zerarCampos();}}
            >
                Ja tenho conta
            </CustomButton>
            <BootstrapDialog
            ...
            >
                ...
                <DialogContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <Typography component="p" sx={{ fontSize: '20px', lineHeight: '24px', fontWeight: 'bold', color: '#000000', width: '100%' }}>
                        Login
                    </Typography>
